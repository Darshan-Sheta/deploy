package com.spring.teambondbackend.registration.model;
...
public class User {
    ...
    private String encryptedRecoveryPrivateKey; // Private key encrypted with Recovery Code
    private String recoveryKeyIv; // IV for the recovery encryption
